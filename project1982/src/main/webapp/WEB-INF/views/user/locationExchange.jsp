...
<script type="text/javascript" src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=7566b035bd910a38bdab34848a049ad8&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
...
function getListItem(index, places) {
    ...
    itemStr = '<span class="markerbg marker_' + (index+1) + '"></span>' +
                ...
                '	<div style="display:none" id="places_y">'+ places.y +'</div>'+
                '	<div style="display:none" id="places_x">'+ places.x +'</div>';

    if (places.road_address_name) {
        itemStr += '    <span id="road_address_name">' + places.road_address_name + '</span>' +
